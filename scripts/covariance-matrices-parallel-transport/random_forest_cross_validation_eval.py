...
def plot_fold_results(results_df, output_path):
    ...
    plt.ylabel('Score')
    plt.title('Random Forest Performance Metrics by Subject (Leave-One-Subject-Out CV)')
    ...
    for metric in metric_cols:
        ...
        ax.set_title(f'{metric.capitalize()} Score by Subject (Random Forest)')
        ...
        plt.tight_layout()
        metric_plot_path = os.path.join(os.path.dirname(output_path), f'random_forest_subject_cv_{metric}.png')
...
def main():
    ...
    # Plot results
    plot_path = os.path.join(output_dir, f'random_forest_subject_cv_results.png')
    plot_fold_results(results['fold_results'], plot_path)
    
    # Save detailed results
    results_path = os.path.join(output_dir, f'random_forest_subject_cv_results.pkl')
