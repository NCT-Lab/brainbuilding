...
INPUT_DISTANCES_FNAME = os.getenv("INPUT_DISTANCES_NAME", 'motor-imagery-augmented-distances-2.h5')
OUTPUT_DIR = os.getenv("OUTPUT_DIR", 'scripts/sequential-subject-elimination/results-augmented')
