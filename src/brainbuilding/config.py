...
REF_CHANNEL_IND = [i for i, ch in enumerate(CHANNELS_IN_STREAM) if ch == REFERENCE_CHANNEL][0]
...
class EEGProcessingConfig:
    ...
    def __post_init__(self):
        ...
        self.channels_mask = np.array([True if ch in self.channels_to_keep else False for ch in self.channels])
